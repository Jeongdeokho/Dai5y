...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_MINAH)
extern struct cpufreq_governor cpufreq_gov_minah;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_minah)
...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_HYERI)
extern struct cpufreq_governor cpufreq_gov_hyeri;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_hyeri)
#endif
