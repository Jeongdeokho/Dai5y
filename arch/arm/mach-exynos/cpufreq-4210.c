...
static unsigned int clkdiv_cpu0[CPUFREQ_LEVEL_END][7] = {
	 ...
	 */
        { 0, 3, 7, 3, 4, 1, 7 },  /* ARM L0 */
        { 0, 3, 7, 3, 4, 1, 7 },  /* ARM L1 */
        { 0, 3, 7, 3, 4, 1, 7 },  /* ARM L2 */
        { 0, 3, 7, 3, 4, 1, 7 },  /* ARM L3 */
        { 0, 3, 7, 3, 4, 1, 7 },  /* ARM L4 */
        { 0, 3, 7, 3, 4, 1, 7 },  /* ARM L5 */
        { 0, 3, 7, 3, 4, 1, 7 },  /* ARM L6 */
        { 0, 3, 7, 3, 4, 1, 7 },  /* ARM L7 */
        { 0, 3, 7, 3, 3, 1, 7 },  /* ARM L8 */
        { 0, 3, 7, 3, 3, 1, 7 },  /* ARM L9 */
        { 0, 3, 7, 3, 3, 1, 7 },  /* ARM L10 */
        { 0, 3, 7, 3, 3, 1, 7 },  /* ARM L11 */
        { 0, 3, 7, 3, 3, 1, 7 },  /* ARM L12 */
        { 0, 3, 7, 3, 3, 1, 7 },  /* ARM L13 */
        { 0, 1, 3, 1, 3, 1, 7 },  /* ARM L14 */
        { 0, 1, 3, 1, 3, 1, 7 },  /* ARM L15 */
};
...
static unsigned int exynos4_apll_pms_table[CPUFREQ_LEVEL_END] = {
        ((240 << 16)|(3 << 8)|(0x1)),        /* APLL FOUT L0 */
        ((375 << 16)|(6 << 8)|(0x1)),        /* APLL FOUT L1 */
        ((350 << 16)|(6 << 8)|(0x1)),        /* APLL FOUT L2 */
        ((325 << 16)|(6 << 8)|(0x1)),        /* APLL FOUT L3 */
        ((150 << 16)|(3 << 8)|(0x1)),        /* APLL FOUT L4 */
        ((275 << 16)|(6 << 8)|(0x1)),        /* APLL FOUT L5 */
        ((250 << 16)|(6 << 8)|(0x1)),        /* APLL FOUT L6 */
        ((225 << 16)|(6 << 8)|(0x1)),        /* APLL FOUT L7 */
        ((200 << 16)|(6 << 8)|(0x1)),        /* APLL FOUT L8 */
        ((180 << 16)|(6 << 8)|(0x1)),        /* APLL FOUT L9 */
        ((160 << 16)|(6 << 8)|(0x1)),        /* APLL FOUT L10 */
        ((260 << 16)|(6 << 8)|(0x2)),        /* APLL FOUT L11 */
        ((110 << 16)|(3 << 8)|(0x2)),        /* APLL FOUT L12 */
        ((160 << 16)|(3 << 8)|(0x3)),        /* APLL FOUT L13 */
        ((200 << 16)|(6 << 8)|(0x3)),        /* APLL FOUT L14 */
        ((160 << 16)|(6 << 8)|(0x3)),        /* APLL FOUT L15 */
};
...
static const unsigned int asv_voltage_A[CPUFREQ_LEVEL_END][8] = {
	 ...
	 * @200  :
	 */
        { 1525000, 1500000, 1475000, 1450000, 1425000, 1400000, 1375000, 1350000 }, /*1920MHz*/
        ...
        { 1160000, 1060000, 1060000, 1035000, 1010000, 985000, 960000, 935000 }, /*720MHz*/
        { 1145000, 1045000, 1045000, 1020000, 1010000, 975000, 950000, 925000 }, /*640MHz*/
        { 1100000, 1000000, 1000000, 975000, 975000, 950000, 925000, 925000 }, /*520MHz*/
        { 1075000, 975000, 1000000, 975000, 975000, 950000, 925000, 925000 }, /*440MHz*/
        { 1075000, 975000, 1000000, 975000, 975000, 950000, 925000, 925000 }, /*320MHz*/
        { 1050000, 950000, 975000, 950000, 950000, 925000, 925000, 925000 }, /*200MHz*/
        { 1050000, 950000, 975000, 950000, 950000, 925000, 925000, 925000 }, /*160MHz*/
